...
<template>
	<div class="top-bg group relative select-none shadow-lg shadow-inset">
		<el-popover :width="400" placement="top" title="切换壁纸" trigger="click">
			<template #reference>
				<!-- 切换按钮 -->
				<el-button
					...
					"
				>
					<i i-solar:pallete-2-bold w-1.6em h-1.6em></i>
				</el-button>
			</template>
			<template #default>
				<ClientOnly>
		...
		<lazy-el-image :src="BaseUrlImg + bgUrl" object-cover class="h-300px object-cover w-1/1" />
	</div>
</template>
