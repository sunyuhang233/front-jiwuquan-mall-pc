...
import { CurrencyType } from "@/composables/api/user/bills";
import { BillsInfoVO, BillsType } from "@/composables/api/user/bills";
...
<template>
	<div class="bills-card pt-6 px-2 border-0 border-default">
		<div class="flex-row-bt-c rounded-6px">
			<i :class="getTypeIcon" p-4.2 mr-4 />
