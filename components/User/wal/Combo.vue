      ...
      <el-scrollbar :height="280" tag="div">
        <div class="grid grid-cols-3 mr-2 grid-gap-3">
          <div
            ...
            :key="p.id" style="aspect-ratio: 1/1" flex-row-c-c flex-col cursor-pointer border-2px rounded-14px leading-1.8em text-bluegray-700 transition-300 active:scale-95 border-default-dashed
            hover:border-solid
