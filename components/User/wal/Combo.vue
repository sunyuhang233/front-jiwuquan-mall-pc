	...
	<div class="cards" v-loading.fullscreen.lock="isLoading">
		...
		<div class="grid grid-cols-3 grid-gap-3 mr-2">
			...
			>
				...
				<small class="block opacity-80 text-center text-0.5em">
					赠送{{ p.points }}积分
				</small>
			</div>
			<div
		...
		<div class="mt-4 flex items-center">
			...
			/>
			<el-button value="充 值" class="border-default px-4" @click="onRechange()" type="info"
				>充 值</el-button
			>
			<small opacity-80 tracking-0.1em>（5-10000元额度）</small>
		</div>
	</div>
</template>
