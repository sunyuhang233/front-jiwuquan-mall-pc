<template>
  <div class="top" flex-row-bt-c>
    ...
    <div flex-3>
      ...
      <ClientOnly>
        <el-autocomplete v-model="searchKeyWords" :fetch-suggestions="getAllHotSearch"  class="inline-input w-50"
        clearable placeholder="搜索商品" @select="handleSelect" />
      </ClientOnly>
    </div>
  </div>
</template>
